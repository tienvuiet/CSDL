...
select  user_id, username, full_name, email, password,created_at
from users
where full_name like 'Nguyễn %'
with check option ;
-- Tiến hành hiển thị lại view vừa tạo được.
select * from view_users_firstname ;
-- Thêm một nhân viên mới vào bảng User có họ “Nguyễn”.
insert into view_users_firstname (username, full_name, email,password) 
    VALUES ('tienvv', 'Nguyễn Việt Tiến', 'tienvv@example.com','151906');
...
from users u
left join view_user_post vup on vup.user_id = u.user_id
